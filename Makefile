...
SOURCES_BONUS	=	checker.c get_next_line.c run_sequence.c libft/ft_atoi.c libft/ft_bzero.c libft/ft_calloc.c libft/ft_isdigit.c libft/ft_putstr.c libft/ft_split.c libft/ft_strcmp.c libft/ft_strlen.c stack/moves.c stack/push.c stack/rotate.c stack/rotate_r.c stack/rotate_utils.c stack/stack.c stack/swap.c 
